...
server.tool("calculate_fba_cost", "按 2026 美国 FBA（非服装）规则计算海运、配置费、配送费和总费用。售价区间为外部输入。", {
  ...inputSchema, season: z.enum(["regular", "peak"]).default("regular"), price_band: z.enum(["10_to_50", "over_50"]).default("10_to_50"), placement: z.enum(["single", "split", "optimized"]).default("single")
